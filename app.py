...
# import urllib.parse
# ##########################
# @app.route('/get_cloud_analysis', methods=['GET'])
# def get_cloud_analysis():
#     try:
...
#         cloud_data = fetch_cloud_data(latitude, longitude)

#         if cloud_data:
#             total_cloud_cover = cloud_data.get('cloud_cover_total', 0)
#             visibility = cloud_data.get('visibility', 0)

#             print(f"[DEBUG] Cloud Data: {cloud_data}")

#             analysis = analyze_data(total_cloud_cover, visibility)

#             encoded_analysis = urllib.parse.quote(analysis)

#             print(f"[DEBUG] Encoded Analysis: {encoded_analysis}")

#             return jsonify({
#                 "msg": encoded_analysis,
#                 "data": cloud_data  # Include cloud data in the response for debugging
#             })
#         else:
#             return jsonify({"msg": "Error fetching cloud data"}), 500
#     except Exception as e:
#         print(f"[ERROR] Exception occurred: {e}")
#         return jsonify({"msg": "Invalid parameters or error fetching data"}), 400

# def analyze_data(cloud_cover_total, visibility):
#     analysis = ""

#     # Analyzing total cloud cover
#     if 0 <= cloud_cover_total <= 20:
#         analysis += f"The weather is clear with a Total Cloud Cover of {cloud_cover_total}%. This is good for farming activities. However, be aware of possible high temperatures causing soil moisture evaporation.\n"
#     elif 20 < cloud_cover_total <= 50:
#         analysis += f"The weather is partly cloudy with a Total Cloud Cover of {cloud_cover_total}%. This is ideal for farming activities like planting or harvesting.\n"
#     elif 50 < cloud_cover_total <= 100:
#         analysis += f"The sky is mostly cloudy with a Total Cloud Cover of {cloud_cover_total}%. This is beneficial for crops sensitive to heat stress and may signal rain, which can be helpful for crops that rely on rainfall.\n"

#     # Analyzing visibility
#     if visibility >= 10000:
#         analysis += f"Visibility is excellent at {visibility} meters. No weather-related impact on outdoor activities.\n"
#     elif 5000 <= visibility < 10000:
#         analysis += f"Visibility is good at {visibility} meters, but there might be minor atmospheric conditions like light fog.\n"
#     elif 1000 <= visibility < 5000:
#         analysis += f"Visibility is moderate at {visibility} meters. Farmers may face difficulties in conducting activities due to reduced sight distances.\n"
#     elif visibility < 1000:
#         analysis += f"Visibility is poor at {visibility} meters, often due to dense fog or heavy rain, which can significantly impact outdoor activities.\n"

#     print(f"[DEBUG] Analysis generated: {analysis}")  # Debugging line
#     return analysis


# def fetch_cloud_data(latitude, longitude):
#     try:
#         url = f"https://barmmdrr.com/connect/gweather_api?latitude={latitude}&longitude={longitude}"
#         response = requests.get(url)
#         response.raise_for_status()
#         data = response.json()
#         print(f"[DEBUG] Fetched Cloud Data: {data}")  # Add this line for debugging
#         return data
#     except requests.exceptions.RequestException as e:
#         print(f"[ERROR] Network or API error: {e}")
#         return None
